...
class DeepCyc(ApiClient):
    ...
    def tcwind_payout(self, portfolio, payout_geometry, payout_table, **kwargs):

        params = kwargs.copy()

        post_data = { 'portfolio': portfolio, 'payout_geometry': payout_geometry, 'payout_table': payout_table }
        self.logger.debug(f'Parameters: {params}')
